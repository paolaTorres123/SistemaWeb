...
public class ListaBecasHospedaje extends VerticalLayout {
    ...
    public ListaBecasHospedaje(){
        setId("listaBecasHospedaje");
        gridBecas = new Grid<Beca>(Beca.class);
        adBeca = new ADBeca();
        gridBecas.setItems(adBeca.obtenerBecasHospedaje());
